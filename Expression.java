...
public class Expression {
	...
	// 随机生成一个分数
	public Fraction fraction_create(final int r) {
		final int choose = random.nextInt(2) + 1;
		int denominator = 1;
		int numerator = 0;
	...
	public char operator_create() {
		final int oper = random.nextInt(4);
		char sign;
		switch (oper) {
		case 0:
			sign = '+';
	...
	// 生成表达式
	public String getexp(final int r) {
		String expression = "";
		final int ran = random.nextInt(3);
		switch (ran) {
		case 0:
	...
	// 一个运算符
	public String oneopexp(final int r) {
		Fraction f1 = fraction_create(r);
		Fraction f2 = fraction_create(r);
		final char op = operator_create();
		String exp = "";
		switch (op) {
		case '+':
			exp = f1 + " + " + f2;
	...
	// 两个运算符
	public String twoopexp(final int r) {
		Fraction f1 = fraction_create(r);
		Fraction f2 = fraction_create(r);
		Fraction f3 = fraction_create(r);

		final char op1 = operator_create();
		final char op2 = operator_create();
		String exp = "";
		String exp1 = "";
		switch (op1) {
		case '+':
	...
	// 三个运算符改
	public String threeopexp(final int r) {
		Fraction f1 = fraction_create(r);
		Fraction f2 = fraction_create(r);
		Fraction f3 = fraction_create(r);
		...
		final char op1 = operator_create();
		final char op2 = operator_create();
		final char op3 = operator_create();
		String exp = "";
		String exp1 = "";
		String exp2 = "";
		switch (op1) {
